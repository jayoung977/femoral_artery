...
def main(args):
    ...
    #load model
    last_model_saved = "/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Model_Save/pretrain/Long_Short/Best_ACC_0.99027 at Epoch_47_Model.tar"
    ...
    print( "Cross_Entropy_Loss : %.5f, Accuracy : %.5f" % (test_loss_mean, test_acc_mean))
    ...
    heatmap = sns.heatmap(df_cm, annot=True, fmt="d",annot_kws={"size": 15})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Save_Path', type=str, default="/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Model_Save/efficientnet_pretrain/mismatched_data_and_confusion_matrix/existing_data/", help="GPU number configuration")
