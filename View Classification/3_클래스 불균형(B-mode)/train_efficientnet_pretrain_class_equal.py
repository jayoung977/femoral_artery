...
if __name__ == '__main__':
    ...
    parser.add_argument('--Save_Path', type=str, default="/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Model_Save/efficientnet_pretrain_class_equal/", help="GPU number configuration")
