...
if __name__ == '__main__':
    ...
    parser.add_argument('--Img_Save_Path', type=str, default="/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Gradcam_Save/bmode_severance_data_Y003_efficientnet_pretrain/", help="GPU number configuration")
