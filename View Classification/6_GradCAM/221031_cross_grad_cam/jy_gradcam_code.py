...
def main(args):
    ...
    # last_model_root_path = "/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Model_Save/"+args.Img_Save_Path.split('/')[-2] +'/' + target.target_name +'/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Img_Save_Path', type=str, default="/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Gradcam_Save/color_efficientnet_pretrain/", help="GPU number configuration")
