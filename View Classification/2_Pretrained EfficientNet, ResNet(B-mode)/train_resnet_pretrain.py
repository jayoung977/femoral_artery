...
def main(args):
    ...
    for epoch in range(start_epoch, args.Epoch):
        ...
        if (Break_Check < 4)  or (Break_Check == 4  and  Break_Flag < 5 ):
        ...
        if (Break_Check == 3 and Break_Flag == 25):
            Break_Check= 4
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Save_Path', type=str, default="/mnt/NAS01/Jayoung/femoral_artery/data2/View_Classification/Model_Save/resnet_pretrain/", help="GPU number configuration")
