...
__all__ = ["EfficientNet", "efficientnet_b0_depth", "efficientnet_b1_depth", "efficientnet_b2_depth", "efficientnet_b3_depth",
           "efficientnet_b4_depth", "efficientnet_b5_depth", "efficientnet_b6_depth", "efficientnet_b7_depth"]


model_urls = {
    # Weights ported from https://github.com/rwightman/pytorch-image-models/
    "efficientnet_b0_depth": "https://download.pytorch.org/models/efficientnet_b0_rwightman-3dd342df.pth",
    "efficientnet_b1_depth": "https://download.pytorch.org/models/efficientnet_b1_rwightman-533bc792.pth",
    "efficientnet_b2_depth": "https://download.pytorch.org/models/efficientnet_b2_rwightman-bcdf34b7.pth",
    "efficientnet_b3_depth": "https://download.pytorch.org/models/efficientnet_b3_rwightman-cf984f9c.pth",
    "efficientnet_b4_depth": "https://download.pytorch.org/models/efficientnet_b4_rwightman-7eb33cd5.pth",
    # Weights ported from https://github.com/lukemelas/EfficientNet-PyTorch/
    "efficientnet_b5_depth": "https://download.pytorch.org/models/efficientnet_b5_lukemelas-b6417697.pth",
    "efficientnet_b6_depth": "https://download.pytorch.org/models/efficientnet_b6_lukemelas-c76e70fd.pth",
    "efficientnet_b7_depth": "https://download.pytorch.org/models/efficientnet_b7_lukemelas-dcc49843.pth",
}
...
class EfficientNet(nn.Module):
    def __init__(
        ...
        # self.classifier[1] = nn.Linear(lastconv_output_channels + 1, num_classes)
        self.linear = nn.Linear(lastconv_output_channels + 1, num_classes)
    ...
    def _forward_impl(self, x: Tensor, depth) -> Tensor:
        x = self.features(x)

        x = self.avgpool(x)
        x = torch.flatten(x, 1)
        # x = self.dropout(x)
        # x = torch.cat((x, depth), 1)  #(3,1280) + (3,1) -> ([3, 1281])
        # x = self.linear(x)
    ...
    def forward(self, x: Tensor,depth) -> Tensor:
...
def efficientnet_b0_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b1_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b2_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b3_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
    ...
    return _efficientnet_model("efficientnet_b3_depth", inverted_residual_setting, 0.3, pretrained, progress, **kwargs)


def efficientnet_b4_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b5_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b6_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
def efficientnet_b7_depth(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> EfficientNet:
    """
...
#     depth = torch.randint(75,size=(3,1)).to(device)
#     model = efficientnet_b3_depth(pretrained=True).to(device)
#     num_ftrs = model.linear.in_features
#     model.linear = nn.Linear(num_ftrs, 64)
#     model.to(device)
#     print(model)
#     output = model(x,depth)
#     print(output)
